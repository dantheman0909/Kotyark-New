    ...
    <>
      ...
      <section className="trust-bar" aria-label="Trust indicators">
        <div className="container">
          <Reveal className="trust-bar-grid" stagger>
      ...
      <section className="section" id="what-is-biodiesel">
        <div className="container">
          <div className="split">
            ...
            <Reveal variant="right" className="split-image sw-media" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <span className="sw-media-accent" aria-hidden="true" />
        ...
        <div className="container">
          ...
          <Reveal className="stats-grid" stagger>
            <div className="stat-card">
              <div className="stat-number"><CountUp end={480} suffix="K" /></div>
              <div className="stat-label">KL Annual Capacity</div>
            </div>
            <div className="stat-card">
              <div className="stat-number"><CountUp end={210} /></div>
              <div className="stat-label">KL/Day Production</div>
            </div>
            <div className="stat-card">
              <div className="stat-number"><CountUp end={86} suffix="%" /></div>
      ...
      <section className="section section-alt" id="products">
        <div className="container">
          ...
          <Reveal className="products-grid" stagger>
      ...
      {/* ============================
          ENVIRONMENTAL IMPACT — parallax band
          ============================ */}
      <section className="sw-band" id="impact" aria-label="Environmental impact">
        <Parallax className="sw-band-bg" speed={0.14} style={{ backgroundImage: 'url(/images/save-planet.jpg)' }} />
        <div className="sw-band-overlay" />
        <div className="container">
          <Reveal>
            <span className="section-tag">Environmental Impact</span>
            <h2>Building a Carbon-Neutral Future</h2>
            <p className="sw-band-lead">
              Every litre of biodiesel from Kotyark replaces petroleum diesel, reducing greenhouse
              gas emissions by up to 86%. With annual capacity of 480,000 kiloliters and
              zero-discharge facilities, we&apos;re making a measurable impact on India&apos;s carbon footprint.
            </p>
          </Reveal>
          <Reveal className="sw-impact-stats" stagger>
            <div className="sw-impact-stat">
              <div className="sw-impact-num"><CountUp end={86} suffix="%" /></div>
              <div className="sw-impact-label">Fewer greenhouse gas emissions than fossil diesel</div>
            </div>
            <div className="sw-impact-stat">
              <div className="sw-impact-num"><CountUp end={100} suffix="%" /></div>
              <div className="sw-impact-label">Biodegradable, non-toxic renewable fuel</div>
            </div>
            <div className="sw-impact-stat">
              <div className="sw-impact-num"><CountUp end={480} suffix="K" /></div>
              <div className="sw-impact-label">KL annual capacity across Rajasthan &amp; Gujarat</div>
            </div>
          </Reveal>
        </div>
      </section>
